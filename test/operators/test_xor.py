...
def test_milp_model(op):
    model_versions = [op.__class__.__name__+"_XORDIFF", op.__class__.__name__+"_XORDIFF_1", op.__class__.__name__+"_XORDIFF_2", op.__class__.__name__+"_TRUNCATEDDIFF", op.__class__.__name__+"_TRUNCATEDDIFF_1", op.__class__.__name__+"_LINEAR", op.__class__.__name__+"_TRUNCATEDLINEAR", op.__class__.__name__+"_INTEGRAL_TWOSUBSET"]
